<?php
/*
  Template Name: staff-emps-tickets
 */
...
switch ($segment) {
    case 0:
        ...
        $queryStatus = "WHERE mju_tickets.status = '0' AND created_by = '".$emp_username."' ";
        break;
    case 1:
        $currentStatus = "مستلمة";
        $queryStatus = "WHERE mju_tickets.status = '1' AND created_by = '".$emp_username."' ";
        break;
    case 2:
        $currentStatus = "تحت التنفيذ";
        $queryStatus = "WHERE mju_tickets.status = '2' AND created_by = '".$emp_username."' ";
        break;
    case 3:
        $currentStatus = "معاد فتحها";
        $queryStatus = "WHERE mju_tickets.status = '3' AND created_by = '".$emp_username."' ";
        break;
    case 4:
        $currentStatus = "مغلقة";
        $queryStatus = "WHERE mju_tickets.status = '4' AND created_by = '".$emp_username."' ";
        break;
    case 5:
        $currentStatus = "الكل";
        $queryStatus = "WHERE created_by = '".$emp_username."' ";
        break;
...
?>
<div class="no-print">
    <a href="staff-home?segment=5">الرئيسية</a> | <a href="staff-emps">عرض الموظفين</a>
</div>
<h4 dir="rtl" style="direction: rtl;"><?php echo "طلبات الموظف  &nbsp;&nbsp;" . $emp_username; ?></h4>
...
<div class="no-print" id="segment" >
    <a href="<?php echo 'staff-emps-tickets?segment=5&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 5)) ? "bordered-segment" : ""; ?>">الكل</a> | 
    <a href="<?php echo 'staff-emps-tickets?segment=0&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 0)) ? "bordered-segment" : ""; ?>">طلبات مفتوحة</a> | 
    <a href="<?php echo 'staff-emps-tickets?segment=1&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 1)) ? "bordered-segment" : ""; ?>">طلبات مستلمة</a> | 
    <a href="<?php echo 'staff-emps-tickets?segment=2&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 2)) ? "bordered-segment" : ""; ?>">طلبات تحت التنفيذ</a> | 
    <a href="<?php echo 'staff-emps-tickets?segment=3&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 3)) ? "bordered-segment" : ""; ?>">طلبات معاد فتحها</a> | 
    <a href="<?php echo 'staff-emps-tickets?segment=4&emp_username='.$emp_username; ?>" class="<?php echo (($segment == 4)) ? "bordered-segment" : ""; ?>">طلبات مغلقة</a>
</div>
