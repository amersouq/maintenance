...
?>
<div class="no-print">
    <a href="staff-emps">عرض الموظفين</a> | <a href="staff-buildings">عرض المباني</a> | <a href="staff-change-password">إعدادات</a>
</div>
...
<div class="no-print" id="segment" >
    <a href="<?php echo 'staff-home?segment=5'; ?>" class="<?php echo (($segment == 5)) ? "bordered-segment" : ""; ?>">الكل</a> | 
    <a href="<?php echo 'staff-home?segment=0'; ?>" class="<?php echo (($segment == 0)) ? "bordered-segment" : ""; ?>">طلبات مفتوحة</a> | 
    <a href="<?php echo 'staff-home?segment=1'; ?>" class="<?php echo (($segment == 1)) ? "bordered-segment" : ""; ?>">طلبات مستلمة</a> | 
    <a href="<?php echo 'staff-home?segment=2'; ?>" class="<?php echo (($segment == 2)) ? "bordered-segment" : ""; ?>">طلبات تحت التنفيذ</a> | 
    <a href="<?php echo 'staff-home?segment=3'; ?>" class="<?php echo (($segment == 3)) ? "bordered-segment" : ""; ?>">طلبات معاد فتحها</a> | 
    <a href="<?php echo 'staff-home?segment=4'; ?>" class="<?php echo (($segment == 4)) ? "bordered-segment" : ""; ?>">طلبات مغلقة</a>
</div>
